...
import { createTrainerAction } from "@/app/actions/trainer/createTrainer.action"
...
export default function CreateTrainerPage() {
  ...
  const [state, formAction, isPending] = useActionState(createTrainerAction, initialState)
  ...
  return (
    <div className="container max-w-3xl mx-auto py-8">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl">Create New Trainer</CardTitle>
          <CardDescription>
            Add a new trainer to the system. Fill in the information below.
          </CardDescription>
        </CardHeader>
        <CardContent>
